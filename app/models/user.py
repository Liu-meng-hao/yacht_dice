...
class User(Base):
    ...
    nickname = Column(String(100), unique=True, nullable=True, comment="用户昵称（用于登录）")
    password = Column(String(255), nullable=True, comment="密码（哈希存储）")
    ...
    current_win_streak = Column(Integer, nullable=False, default=0, comment="当前连胜数")
    max_win_streak = Column(Integer, nullable=False, default=0, comment="最大连胜数")
    max_win_streak_time = Column(DateTime, nullable=True, comment="最大连胜达成时间")
